    ...
    <Router>
      ...
      <div
        className={`min-h-screen bg-gray-50 transition-all duration-300 ${
          token ? "pl-64" : "" // push content if sidebar exists
        }`}
      >
        <Routes>
          <Route
          ...
          <Route
            ...
            element={
              token && hasAccess(["FREELANCER", "ADMIN"]) ? (
                <FreelancerDashboard />
              ) : (
                <Navigate to="/login" />
              )
          ...
          <Route
            path="/contracts"
            element={
              token && hasAccess(["CLIENT", "FREELANCER", "ADMIN"]) ? (
                <Contracts />
              ) : (
                <Navigate to="/login" />
              )
          ...
          />
          <Route
            path="/projects/:projectId/milestones/:milestoneId/upload"
            element={
              token && hasAccess(["CLIENT", "FREELANCER", "ADMIN"]) ? (
                <FileUpload />
              ) : (
